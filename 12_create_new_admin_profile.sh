...
printf "${R}CREATE ROLE admin2 PASSWORD 'password_admin2' PROFILE admin_profile;${N}\n\n"
psql -h $DBHOST -p 5444 -U enterprisedb -c "CREATE ROLE admin2 PASSWORD 'initial_password_admin2' PROFILE admin_profile;" edb
...
psql -h $DBHOST -p 5444 -U enterprisedb -c "SELECT rolname, rolprofile FROM pg_catalog.pg_authid WHERE rolname = 'admin2';" edb
